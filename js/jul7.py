...
def checkForFactor(base,testFactor):
    if base % testFactor == 0:
        return str(testFactor) + ' is indeed a factor of ' + str(base)
    else:
        return str(testFactor) + ' is indeed NOT a factor of ' + str(base) + ' ,try another number'
